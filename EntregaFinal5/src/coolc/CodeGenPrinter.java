...
"%"+mainClass+" = type { i8* }\n";
    ...
    public void defineInt(String value){
    	String content = "i32 " + value;
    	System.out.println(content);
    }
    
    public void defineBool(String value){
    	String content = "i1 " + value;
    	System.out.println(content);
    }

    
    public void defineString(String s){
    ...
    public void defineFunction(Method m) {
    	String content = "define i32 @"+m.getName()+"(" ;
...
public void defineFunction(DispatchExpr m) {
...
// %IO* @out_string(%IO* %self, i8* %x)
   ...
   public void printMethods2(String className){
